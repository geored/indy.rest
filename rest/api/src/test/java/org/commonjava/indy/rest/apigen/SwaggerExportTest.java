...
//
//        Arrays.asList( ).forEach( ext->{ // "yaml", "json"
//            HttpGet get = new HttpGet(UrlUtils.buildUrl( "http://" + fixture.getBootOptions().getIndyHome()  + ":" + fixture.getBootOptions().getPort(), "swagger." + ext ) );
//
